...
public final class TMDataControl_Skel
    ...
    implements java.rmi.server.Skeleton
{
    ...
    public void dispatch(java.rmi.Remote obj, java.rmi.server.RemoteCall call, int opnum, long hash) throws java.rmi.RemoteException, Exception {
        ...
        G_APPL.TMDataControl server = (G_APPL.TMDataControl)obj;
        switch (opnum) {
        case 0: { // IAcc_PayEnrol
            int $_int_1;
            boolean $_boolean_2;
            try {
