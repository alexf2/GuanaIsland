...
BOOL TMyDataCombo::OnHelpInfo( HELPINFO* lpHelpInfo )
	{
	  if( lpHelpInfo->iContextType != HELPINFO_WINDOW )
	    return Default();
			...
			static pair<int, TCtxBnd> arrInit[] =
				{				  
						pair<int, TCtxBnd>( IDC_DATALIST_CAT, TCtxBnd(IDH_LstFltCat, HELP_CONTEXT) )						
				};
...
BEGIN_MESSAGE_MAP( TMyDataCombo, CDataCombo )  
		ON_WM_HELPINFO()
END_MESSAGE_MAP()
